            ...
            with torch.no_grad():
                ...
                if (i + 1) % 34 == 0:
                    ...
                    if acc > temp_acc:
                        ...
                        np.savetxt('./data_result_resnet50_TSM_10p_10pixel/resnet_3D_fpr_0' + save_name + '.txt', fpr)
                        np.savetxt('./data_result_resnet50_TSM_10p_10pixel/resnet_3D_tpr_0' + save_name + '.txt', tpr)
                        np.savetxt('./data_result_resnet50_TSM_10p_10pixel/resnet50_TSM_data_result_0' + save_name + '.txt', data_result)
                        np.savetxt('./data_result_resnet50_TSM_10p_10pixel/resnet50_TSM_y_test_0' + save_name + '.txt', y_true)
                        np.savetxt('./data_result_resnet50_TSM_10p_10pixel/resnet50_TSM_y_pred_probability_0' + save_name + '.txt',
                                   y_pred_probability_test)
                        np.savetxt('./data_result_resnet50_TSM_10p_10pixel/resnet50_TSM_y_pred_0' + save_name + '.txt', y_pred)
                        # 保存模型
                        # torch.save(model,
