...
def validate(batch_size, model, criterion,
    ...
    print('acc = ', acc)
    return y_pred_test, y_true_test, y_pred_probability_test
...
class resnet50_TSM(nn.Module):
    ...
    def feature_extract(self, x):
        ...
        for i in range(x.shape[0]):
            ...
            output = self.tsm(input_tsm)   # TSM 处理 ——input_tsm：(N* 8, C=3, W, H=W)   # [self.img_num , 3, 80, 80]
...
def train():
    ...
    # 一、 行为数据：眼睛、嘴巴、头部位姿
    # 1. 嘴巴
    data_set_mouthRIO_T1 = np.load(r'/home/ps/lab-data/MoHaiMiao/2021-05-anxiety_screen-paper2/2021-11-09-dataset_UBFC_Phys/dataset_UBFC_Phys_T1/mouth_ROI_T1_56_6090_40_40pixels/'
                                   + 'mouth_ROI_T1_56_6090_10_10pixels.npy')/ 255
    data_set_mouthRIO_T2 =np.load(r'/home/ps/lab-data/MoHaiMiao/2021-05-anxiety_screen-paper2/2021-11-09-dataset_UBFC_Phys/dataset_UBFC_Phys_T2/mouth_ROI_T2_56_6090_40_40pixels/'
    ...
    # 2. 左眼
    data_set_eyeLeftRIO_T1 = np.load(r'/home/ps/lab-data/MoHaiMiao/2021-05-anxiety_screen-paper2/2021-11-09-dataset_UBFC_Phys/dataset_UBFC_Phys_T1/eyeLeft_ROI_T1_56_6090_40_40pixels/'
    ...
    # 3. 右眼
    data_set_eyeRightRIO_T1 = np.load(r'/home/ps/lab-data/MoHaiMiao/2021-05-anxiety_screen-paper2/2021-11-09-dataset_UBFC_Phys/dataset_UBFC_Phys_T1/eyeRight_ROI_T1_56_6090_40_40pixels/'
    ...
    data_set_ippg_forehead_T1 = np.load(r'/home/ps/lab-data/MoHaiMiao/2021-05-anxiety_screen-paper2/2021-11-09-dataset_UBFC_Phys/dataset_UBFC_Phys_T1/ippg_forehead_T1_56_3_6090/'
                                   +'ippg_forehead_T1_56_3_6090.npy')/ 255
    data_set_ippg_forehead_T2 = np.load(r'/home/ps/lab-data/MoHaiMiao/2021-05-anxiety_screen-paper2/2021-11-09-dataset_UBFC_Phys/dataset_UBFC_Phys_T2/ippg_forehead_T2_56_3_6090/'
    ...
    # # 6. nose iPPG
    data_set_ippg_nose_T1 = np.load(r'/home/ps/lab-data/MoHaiMiao/2021-05-anxiety_screen-paper2/2021-11-09-dataset_UBFC_Phys/dataset_UBFC_Phys_T1/ippg_nose_T1_56_3_6090/'
                                    +'ippg_nose_T1_56_3_6090.npy')/ 255
    data_set_ippg_nose_T2 = np.load(r'/home/ps/lab-data/MoHaiMiao/2021-05-anxiety_screen-paper2/2021-11-09-dataset_UBFC_Phys/dataset_UBFC_Phys_T2/ippg_nose_T2_56_3_6090/'
        ...
        for i in range(total_step):
            ...
            with torch.no_grad():
                ...
                if (i + 1) % 34 == 0:
                    ...
                    ## 评价模型
                    y_pred_test, y_true_test, y_pred_probability_test = validate(batch_size, model, criterion,
                             y_labels_val,
                             data_set_mouthRIO_test,
                             data_set_eyeLeftRIO_test, data_set_eyeRightRIO_test,
                             data_set_location_test,
    ...
    np.savetxt('./data_result_resnet50_TSM_10p_10pixel/resnet50_TSM_y_pred_probability' + save_name + '.txt', y_pred_probability_test)
    np.savetxt('./data_result_resnet50_TSM_10p_10pixel/resnet50_TSM_y_pred' + save_name + '.txt', y_pred)
    # 保存模型
    torch.save(model, './data_result_resnet50_TSM_10p_10pixel/resnet50_TSM_mod4_0_1_anxiety_screeen' + save_name + '.pkl')
